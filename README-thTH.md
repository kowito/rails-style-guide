...
> -- เจ้าหน้าที่ อเล็กซ์ เจ เมอร์ฟีย์ / โรโบคอป

เป้าหมายของคู่มือนี้จะนำเสนอแนวทางในการปฏิบัติที่ดีที่สุดและรูบแบบการเขียนที่ดี
สำหรับการพัฒนาบน Ruby on Rails 4 มันเป็นคู่มือประกอบกับที่ผลักดันด้วยชุมชนนักพัฒนา
[Ruby coding style guide](https://github.com/bbatsov/ruby-style-guide).

บางส่วนของคำแนะนำนี้ เป็นคำแนะนำเฉพาะRuby on Rails 4.0+ ขึ้นไป

คุณสามารถสร้าง PDF หรือ HTML ของคู่มือนี้โดยใช้
[Transmuter](https://github.com/TechnoGate/transmuter).

การแปลของคู่มือที่มีอยู่ในภาษาต่อไปนี้:
...
# คู่มือรูปแบบการเขียน Rails

คู่มือรูปแบบการเขียน Rails แนะนำข้อปฏิบัติที่ดีที่สุดเพื่อให้ Rails โปรแกรมเมอร์
สามารถเขียนโค้ดที่สามารถดูแลรักษาได้ด้วย Rails โปรแกรมเมอร์คนอื่นๆ

คู่มือรูปแบบการเขียนนี้สะท้อนให้เห็นถึงการใช้งานในโลกแห่งความเป็นจริง และคำแนะนำ
รูปแบบที่มีอุดมคติที่ได้รับการปฏิเสธโดยคนที่มันควรจะช่วยให้ความเสี่ยงที่ไม่ได้รับการใช้งาน
ไม่ว่ามันจะดีแค่ใหน
